...
class StorefrontProductDetailInfo extends StatelessWidget {
  final StorefrontProduct product;

  const StorefrontProductDetailInfo({super.key, required this.product});
    ...
    return Column(
      ...
      children: [
        ...
        InfoRow(
          ...
          label: S().unitPrice,
          value: S().currencyEgp(product.price),
        ),
