...
import '../../domain/repos/i_barber_notifications_repo.dart';
import '../apis/barber_notifications_api.dart';
import '../models/notification_page_model.dart';

class BarberNotificationsRepo implements IBarberNotificationsRepo {
  final BarberNotificationsApi _api;

  BarberNotificationsRepo(this._api);
