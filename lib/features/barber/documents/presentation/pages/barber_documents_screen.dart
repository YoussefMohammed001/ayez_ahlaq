...
class BarberDocumentsScreen extends StatefulWidget {
  ...
  const BarberDocumentsScreen({super.key, this.blocking = false});
...
class _BarberDocumentsScreenState extends State<BarberDocumentsScreen> {
  ...
  void initState() {
    super.initState();
    context.read<BarberDocumentsCubit>().loadDocuments();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<BarberDocumentsCubit, BarberDocumentsState>(
        builder: (context, state) {
          ...
          if (state.status == DocumentsStatus.failure &&
            ...
            return AppErrorState(
              ...
              onRetry: context.read<BarberDocumentsCubit>().loadDocuments,
            );
          }
          ...
          return RefreshIndicator(
            onRefresh: context.read<BarberDocumentsCubit>().loadDocuments,
            child: ListView(
