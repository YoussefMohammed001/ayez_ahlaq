              ...
              children: [
                ...
                Container(
                  ...
                  child: const TextField(
                    ...
                    decoration: InputDecoration(border: InputBorder.none, hintText: 'صالون الملك، مدينة نصر', hintStyle: TextStyle(color: AppColors.ivory700)),
                  ),
                ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      for (final id in ids)
                        _SummaryLine(left: '${state.cart[id]}×', right: MockData.products.firstWhere((p) => p.id == id).name),
                ...
                ElevatedButton(
                  ...
                  onPressed: ids.isEmpty
                      ...
                      : () {
                          ...
                          Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (_) => OrderSuccessScreen(orderCode: order.code)));
                        },
